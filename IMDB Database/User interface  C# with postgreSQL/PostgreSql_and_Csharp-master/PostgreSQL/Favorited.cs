...
namespace PgSql
{
    public partial class Favorited : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataItems = pgTest.PostgreSQLtest9();                  //vale stin metavliti dataitems, oti exi epistrepsi to PostgreSQLtest2
        ...
        private void Favorited_FormClosed(object sender, FormClosedEventArgs e)
        {
